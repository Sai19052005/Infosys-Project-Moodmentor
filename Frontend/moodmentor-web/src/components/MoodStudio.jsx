...
const FILTER_CATEGORIES = [
  {
    ...
    filters: [
      ...
      },
      {
        ...
        name: 'Calm Tide',
        icon: '🌊',
        note: 'Cool ocean tones for a softer pause.',
        css: 'saturate(.78) hue-rotate(155deg)',
      },
      {
        id: 'glow',
        name: 'Golden Hour',
        icon: '🌅',
        note: 'Warm sunset light for a little lift.',
        css: 'sepia(.28) saturate(1.16) brightness(1.07)',
      },
      {
        id: 'focus',
        name: 'Focus',
        icon: '🎯',
        note: 'A clear, quiet frame for clarity.',
        css: 'contrast(1.12) saturate(.72)',
      },
      {
        id: 'joy',
        name: 'Joy Spark',
        icon: '✨',
        note: 'Vibrant and playful energy.',
        css: 'saturate(1.25) brightness(1.07)',
      },
      {
        id: 'midnight',
        name: 'Midnight Blue',
        icon: '🌙',
        note: 'Deep, calming night tones.',
        css: 'saturate(.6) hue-rotate(200deg) brightness(.85)',
      },
      {
        id: 'sunset',
        name: 'Sunset Blush',
        icon: '🌸',
        note: 'Soft pink-gold warmth.',
        css: 'sepia(.2) saturate(1.3) hue-rotate(-15deg) brightness(1.05)',
      },
      {
        id: 'forest',
        name: 'Forest Calm',
        icon: '🌲',
        note: 'Earthy greens for grounding.',
        css: 'saturate(.85) hue-rotate(70deg) brightness(.95)',
      },
      {
        id: 'lavender',
        name: 'Lavender Dream',
        icon: '💜',
        note: 'Gentle purple serenity.',
        css: 'saturate(.8) hue-rotate(260deg) brightness(1.05)',
      },
      {
        id: 'ocean',
        name: 'Ocean Mist',
        icon: '🐚',
        note: 'Soft teal, like a sea breeze.',
        css: 'saturate(.7) hue-rotate(140deg) brightness(1.08)',
      },
      {
        id: 'retro',
        name: 'Retro Warm',
        icon: '📸',
        note: 'Vintage film nostalgia.',
        css: 'sepia(.45) contrast(1.1) brightness(.95) saturate(1.1)',
      },
    ],
  },
  {
    ...
    filters: [
      {
        ...
        icon: '🫧',
        note: 'Gentle bubbles drifting up.',
        css: 'none',
        particle: 'bubbles',
      },
      {
        ...
        name: 'Fireflies',
        icon: '✨',
        note: 'Warm glowing lights around you.',
        css: 'sepia(.15) brightness(1.05)',
        particle: 'fireflies',
      },
      {
        id: 'petals',
        ...
        icon: '🌸',
        note: 'Soft petals falling gently.',
      ...
      },
      {
        ...
        name: 'Gentle Snow',
        icon: '❄️',
        note: 'Quiet snowfall for calm.',
        css: 'saturate(.7) brightness(1.1)',
        particle: 'snow',
      },
    ],
  },
    ...
    filters: [
      {
        ...
        name: 'Bunny Bloom',
        icon: '🐰',
        note: 'Soft ears, pink nose, and whiskers that follow you.',
        css: 'brightness(1.04) saturate(1.08)',
        ar: 'bunny',
      },
      {
        id: 'puppy',
        name: 'Puppy Play',
        icon: '🐶',
        note: 'Floppy ears, playful snout, and interactive tongue.',
        css: 'brightness(1.03) saturate(1.12)',
        ar: 'puppy',
      },
      {
        id: 'celebrate',
        name: 'Royal Crown',
        icon: '👑',
        note: 'Gilded crown with jewels and celestial sparkles.',
      ...
      },
      {
        ...
        name: 'Kitty Glam',
        icon: '🐱',
        note: 'Cute cat ears, rosy cheeks, and whiskers.',
      ...
      },
      {
        ...
        name: 'Cool Aviators',
        icon: '🕶️',
        note: 'Glossy dark sunglasses locked to your eyes.',
        css: 'contrast(1.1) brightness(1.02)',
        ar: 'shades',
      },
      {
        id: 'halo',
        name: 'Angel Halo',
        icon: '😇',
        note: 'Glowing golden halo and angelic sparkle aura.',
        css: 'brightness(1.1) saturate(1.1)',
        ar: 'halo',
      },
      {
        id: 'heart_eyes',
        name: 'Heart Eyes',
        icon: '😍',
        note: 'Pulsing anime heart eyes with floating love sparks.',
        css: 'brightness(1.05) saturate(1.2)',
        ar: 'heart_eyes',
      },
      {
        id: 'devil',
        name: 'Neon Devil',
        icon: '😈',
        note: 'Glowing cyberpunk horns with a mysterious vibe.',
        css: 'contrast(1.15) brightness(0.95)',
        ar: 'devil',
      },
      {
        id: 'star_freckles',
        name: 'Star Freckles',
        icon: '✨',
        note: 'Twinkling golden star freckles and cosmic dust.',
      ...
      },
      {
        ...
        name: 'Clown Nose',
        icon: '🤡',
        note: 'Bouncy red nose that jiggles when you move!',
        css: 'brightness(1.06) saturate(1.15)',
        ar: 'clown',
      },
      {
        id: 'pirate',
        name: 'Pirate Captain',
        icon: '🏴‍☠️',
        note: 'Arrr! Eye patch and bandana, matey!',
        css: 'sepia(.15) contrast(1.1)',
        ar: 'pirate',
      },
      {
        id: 'rainbow_tears',
        name: 'Rainbow Tears',
        icon: '🌈',
        note: 'Colorful rainbow streams flowing from your eyes.',
        css: 'brightness(1.08) saturate(1.25)',
        ar: 'rainbow_tears',
      },
      {
        id: 'wizard',
        name: 'Wizard Hat',
        icon: '🧙',
        note: 'Magical wizard hat with orbiting sparkles.',
        css: 'brightness(1.05) saturate(1.12)',
        ar: 'wizard',
      },
      {
        id: 'alien',
        name: 'Alien Antenna',
        icon: '👽',
        note: 'Bobbing antennae and glowing alien eyes.',
        css: 'hue-rotate(80deg) brightness(1.05)',
        ar: 'alien',
      },
      {
        id: 'flower_crown',
        name: 'Flower Crown',
        icon: '🌺',
        note: 'Beautiful ring of flowers around your head.',
        css: 'brightness(1.1) saturate(1.2)',
        ar: 'flower_crown',
      },
      {
        id: 'gentleman',
        name: 'Gentleman',
        icon: '🎩',
        note: 'Top hat, monocle, and a dapper curly mustache.',
        css: 'sepia(.1) contrast(1.08)',
        ar: 'gentleman',
      },
      {
        id: 'tiger',
        name: 'Tiger Face',
        icon: '🐯',
        note: 'Fierce tiger stripes, nose, and whiskers.',
        css: 'saturate(1.2) contrast(1.08)',
        ar: 'tiger',
      },
      {
        id: 'butterfly',
        ...
        icon: '🦋',
        note: 'Fluttering butterfly wings beside your temples.',
        css: 'brightness(1.08) saturate(1.18)',
        ar: 'butterfly',
      },
      {
        ...
        name: 'Frog Face',
        icon: '🐸',
        note: 'Big bulging frog eyes and a wide goofy grin.',
        css: 'brightness(1.05) saturate(1.1) hue-rotate(40deg)',
        ar: 'frog',
      },
      {
        id: 'ice_queen',
        name: 'Ice Queen',
        icon: '❄️',
        note: 'Frozen tiara with ice crystals and frosty cheeks.',
        css: 'brightness(1.1) saturate(.75) hue-rotate(190deg)',
        ar: 'ice_queen',
      },
      {
        id: 'fire_aura',
        name: 'Fire Aura',
        icon: '🔥',
        note: 'Dancing flames and rising ember sparks.',
        css: 'contrast(1.12) saturate(1.3)',
        ar: 'fire_aura',
      },
    ],
  },
    ...
    this.particles.forEach((p) => {
      switch (this.type) {
        case 'bubbles':
          ...
          if (p.y + p.radius < 0)
            Object.assign(p, this.createParticle(), { y: h + p.radius })
          break
        case 'fireflies':
...
function drawBunny(ctx, landmarks, width, height) {
  ...
  ;[-1, 1].forEach((dir) => {
    for (const rise of [-0.04, 0.01, 0.06]) {
      ctx.beginPath()
      ctx.moveTo(
        m.nose.x + dir * m.faceWidth * 0.08,
        m.nose.y + rise * m.faceWidth,
      )
      ctx.lineTo(
        m.nose.x + dir * m.faceWidth * 0.45,
        m.nose.y + rise * m.faceWidth * 1.5,
      )
      ctx.stroke()
    }
  })
...
function drawCelebrate(ctx, landmarks, width, height, timestamp) {
  ...
  for (let i = 0; i < 6; i++) {
    const angle =
      (timestamp || performance.now()) / 800 + (i * (Math.PI * 2)) / 6
...
function drawCat(ctx, landmarks, width, height) {
  ...
  ;[-1, 1].forEach((dir) => {
    for (const rise of [-0.03, 0.02, 0.07]) {
      ctx.beginPath()
      ctx.moveTo(
        m.nose.x + dir * m.faceWidth * 0.07,
        m.nose.y + rise * m.faceWidth,
      )
      ctx.lineTo(
        m.nose.x + dir * m.faceWidth * 0.42,
        m.nose.y + rise * m.faceWidth * 1.6,
      )
      ctx.stroke()
    }
  })
...
function drawHalo(ctx, landmarks, width, height, timestamp) {
  ...
  const bob =
    Math.sin((timestamp || performance.now()) / 400) * (m.faceWidth * 0.03)
  ...
  for (let i = 0; i < 5; i++) {
    ...
    const sy =
      m.forehead.y - m.faceWidth * 0.35 + Math.sin(angle) * m.faceWidth * 0.15
...
function drawHeartEyes(ctx, landmarks, width, height, timestamp) {
  ...
  ;[m.leftEyeCenter, m.rightEyeCenter].forEach((eye) => {
    ...
    ctx.beginPath()
    ctx.arc(
      eye.x - heartSize * 0.22,
      eye.y - heartSize * 0.25,
      heartSize * 0.1,
      0,
      Math.PI * 2,
    )
  ...
  for (let i = 0; i < 4; i++) {
    ...
    const hx =
      m.forehead.x + (i % 2 === 0 ? -1 : 1) * (m.faceWidth * 0.38 + i * 15)
...
function drawStarFreckles(ctx, landmarks, width, height, timestamp) {
  ...
  const frecklePositions = [
    ...
    { x: m.nose.x + m.faceWidth * 0.08, y: m.nose.y - m.faceWidth * 0.02 },
    {
      x: m.leftCheek.x + m.faceWidth * 0.12,
      y: m.leftCheek.y - m.faceWidth * 0.05,
    },
    { x: m.leftCheek.x + m.faceWidth * 0.2, y: m.leftCheek.y },
    {
      x: m.rightCheek.x - m.faceWidth * 0.12,
      y: m.rightCheek.y - m.faceWidth * 0.05,
    },
  ...
  frecklePositions.forEach((pos, idx) => {
    const twinkle =
      0.5 + 0.5 * Math.sin((timestamp || performance.now()) / 250 + idx)
    drawStar(
      ctx,
      pos.x,
      pos.y,
      4,
      m.faceWidth * 0.025 * twinkle,
      m.faceWidth * 0.008 * twinkle,
      '#fde047',
    )
  })
...
function drawClown(ctx, landmarks, width, height, timestamp) {
  ...
  ;[m.leftCheek, m.rightCheek].forEach((chk) => {
    ctx.beginPath()
    ctx.arc(
      chk.x + (chk === m.leftCheek ? m.faceWidth * 0.08 : -m.faceWidth * 0.08),
      chk.y,
      m.faceWidth * 0.1,
      0,
      Math.PI * 2,
  ...
  ;[m.leftEyeCenter, m.rightEyeCenter].forEach((eye) => {
    for (let i = 0; i < 3; i++) {
      ...
      const sy =
        ...
        m.faceWidth * 0.06 +
        tearLen +
        Math.cos(sparkA) * m.faceWidth * 0.04
      drawStar(
        ctx,
        sx,
        sy,
...
function drawWizard(ctx, landmarks, width, height, timestamp) {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    drawStar(
      ...
      sy,
      4,
      m.faceWidth * 0.035 * twinkle,
      m.faceWidth * 0.015 * twinkle,
      i % 2 === 0 ? '#fde047' : '#c084fc',
    )
  }
  ctx.restore()
...
function drawAlien(ctx, landmarks, width, height, timestamp) {
  ...
  ;[-1, 1].forEach((dir) => {
    ...
    ctx.beginPath()
    ctx.arc(
      tipX - m.faceWidth * 0.015,
      tipY - m.faceWidth * 0.02,
      m.faceWidth * 0.02,
      0,
      Math.PI * 2,
    )
...
function drawTiger(ctx, landmarks, width, height) {
  ...
  ;[-1, 1].forEach((dir) => {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      ctx.beginPath()
      ctx.moveTo(
        cx + dir * m.faceWidth * 0.02,
        cheek.y + yOff - m.faceWidth * 0.03,
      )
      ctx.quadraticCurveTo(
        cx + dir * m.faceWidth * 0.08,
        cheek.y + yOff,
        cx + dir * m.faceWidth * 0.02,
        cheek.y + yOff + m.faceWidth * 0.03,
      )
  ...
  ;[-1, 1].forEach((dir) => {
    for (const rise of [-0.04, 0.01, 0.06]) {
      ctx.beginPath()
      ctx.moveTo(
        m.nose.x + dir * m.faceWidth * 0.1,
        m.nose.y + rise * m.faceWidth,
      )
      ctx.lineTo(
        m.nose.x + dir * m.faceWidth * 0.48,
        m.nose.y + rise * m.faceWidth * 1.4,
      )
      ctx.stroke()
    }
  })
...
function drawButterfly(ctx, landmarks, width, height, timestamp) {
  ...
  ;[-1, 1].forEach((dir) => {
    ...
    ctx.save()
    ctx.translate(
      temple.x + dir * m.faceWidth * 0.15,
      temple.y - m.faceWidth * 0.15,
    )
    ctx.rotate(m.angle)
    ...
    ctx.quadraticCurveTo(
      dir * m.faceWidth * 0.05,
      -m.faceWidth * 0.12,
      dir * m.faceWidth * 0.04,
      -m.faceWidth * 0.15,
    )
    ctx.stroke()
    ctx.fillStyle = '#1c1917'
...
function drawFrog(ctx, landmarks, width, height) {
  ...
  ;[m.leftEyeCenter, m.rightEyeCenter].forEach((eye) => {
    ...
    ctx.arc(
      eye.x - bulgeR * 0.15,
      eye.y - m.faceWidth * 0.05 - bulgeR * 0.15,
      bulgeR * 0.15,
      0,
      Math.PI * 2,
    )
  ...
  ctx.beginPath()
  ctx.moveTo(
    m.leftCheek.x + m.faceWidth * 0.1,
    m.upperLip.y + m.faceWidth * 0.02,
  )
  ctx.quadraticCurveTo(
    m.nose.x,
    m.upperLip.y + m.faceWidth * 0.08,
...
function drawIceQueen(ctx, landmarks, width, height, timestamp) {
  ...
  ;[m.leftCheek, m.rightCheek].forEach((chk) => {
    ctx.beginPath()
    ctx.arc(
      chk.x + (chk === m.leftCheek ? m.faceWidth * 0.06 : -m.faceWidth * 0.06),
      chk.y,
      m.faceWidth * 0.12,
      0,
      Math.PI * 2,
  ...
  for (let i = 0; i < 8; i++) {
    ...
    drawStar(
      ...
      sy,
      6,
      m.faceWidth * 0.03 * twinkle,
      m.faceWidth * 0.012 * twinkle,
      '#bae6fd',
    )
  }
  ctx.restore()
...
function drawFireAura(ctx, landmarks, width, height, timestamp) {
  ...
  for (let i = 0; i < flameCount; i++) {
    ...
    ctx.quadraticCurveTo(
      fx - m.faceWidth * 0.03 + phase * m.faceWidth * 0.1,
      -flameH * 0.6,
      fx + phase * m.faceWidth * 0.05,
      -flameH,
    )
    ctx.quadraticCurveTo(
      fx + m.faceWidth * 0.03 + phase * m.faceWidth * 0.1,
  ...
  for (let i = 0; i < 10; i++) {
    ...
    ctx.fillStyle =
      i % 3 === 0 ? '#fde047' : i % 3 === 1 ? '#f97316' : '#ef4444'
    ctx.beginPath()
    ctx.arc(
      ex + Math.sin(t / 200 + i) * m.faceWidth * 0.04,
      ey,
      size,
      0,
      Math.PI * 2,
...
export default function MoodStudio() {
  ...
  const currentFilter =
    FILTER_CATEGORIES.flatMap((c) => c.filters).find(
      (f) => f.id === selected,
    ) || FILTER_CATEGORIES[0].filters[0]
  ...
  useEffect(() => {
    ...
    if (currentFilter.particle) {
      ...
      particleSystemRef.current.init(
        currentFilter.particle === 'snow' ? 100 : 40,
      )
  ...
  function stopCamera() {
    ...
    arCanvasRef.current
      ?.getContext('2d')
      .clearRect(0, 0, arCanvasRef.current.width, arCanvasRef.current.height)
    setTrackingState('idle')
    setCameraState('idle')
  }
  ...
  async function beginBreathing() {
    ...
    for (let round = 1; round <= totalRounds; round++) {
      ...
      setBreathText(
        `Breathe in · ${pattern.inhale} (Round ${round}/${totalRounds})`,
      )
    ...
    <section className="studio-layout">
      <article className="studio-stage">
        <div className={`camera-frame filter-${selected}`}>
          <video
            ...
            style={{
              filter:
                currentFilter.css !== 'none' ? currentFilter.css : undefined,
            }}
          />
          <canvas
          ...
          />
          <canvas ref={arCanvasRef} className="ar-canvas" aria-hidden="true" />

          {showAffirmation && cameraState === 'ready' && (
            <div
              className="affirmation-overlay"
              style={{
                position: 'absolute',
                bottom: '10%',
                left: '50%',
          ...
          {cameraState === 'ready' && (
            <>
              ...
              {currentFilter.ar && (
                <div className={`tracking-pill tracking-${trackingState}`}>
                  {trackingState === 'ready'
                    ? '✦ Face tracking on'
                    : trackingState === 'loading'
                      ? '◌ Loading face effect…'
                      : '⚠ Face effect unavailable'}
                </div>
              )}
          ...
          {cameraState === 'ready' ? (
            <>
              <button
                ...
                onClick={stopCamera}
                disabled={photoBoothActive}
              >
                Turn off
              </button>
              <button
                className="photobooth-btn camera-action"
              ...
              <button
                ...
                disabled={photoBoothActive}
                aria-label="Save a private snapshot"
              >
                <i />
              </button>
              <button
      ...
      <aside className="studio-panel">
        <div>
          ...
          <p className="muted">
            These filters are visual only. They do not read, store, or diagnose
            your emotions.
          </p>
        </div>
          ...
          {FILTER_CATEGORIES.map((cat, idx) => (
            <button
              ...
              style={{
                padding: '0.5rem 1rem',
                borderRadius: '20px',
                border: activeTab === idx ? '2px solid #333' : '1px solid #ccc',
          ...
          <div style={{ flex: 1 }}>
            ...
            {!breathing && (
              <select
                ...
                onChange={(e) =>
                  setSelectedBreathPattern(Number(e.target.value))
                }
                style={{
                  display: 'block',
                  marginTop: '0.5rem',
        ...
        <p className="studio-privacy">
          ⌁ Your video never leaves this browser. Saved moments download only to
          your device.
        </p>
      </aside>
    </section>
